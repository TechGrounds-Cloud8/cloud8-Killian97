...
map_tile_image = {
   "G" : pygame.transform.scale(pygame.image.load("C:/Users/Lenovo/Documents/GitHub/cloud8-Killian97/Minigame Project/imgs/grass1.png"), (config.SCALE, config.SCALE)),
   "W" : pygame.transform.scale(pygame.image.load("C:/Users/Lenovo/Documents/GitHub/cloud8-Killian97/Minigame Project/imgs/water1.png"), (config.SCALE, config.SCALE))
}